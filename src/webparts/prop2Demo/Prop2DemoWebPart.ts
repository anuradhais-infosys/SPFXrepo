...
import styles from './Prop2DemoWebPart.module.scss';
import * as strings from 'Prop2DemoWebPartStrings';

export interface IProp2DemoWebPartProps {
...
export default class Prop2DemoWebPart extends BaseClientSideWebPart<IProp2DemoWebPartProps> {

  public render(): void {
    this.domElement.innerHTML = `
      <div class="${ styles.prop2Demo }">
